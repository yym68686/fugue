...
func TestAPIGuardianHandoffBindsProductionLKG(t *testing.T) {
	...
	const failedAtom = "48ae128ddb62c4dbde783a7357561bb34003ef71"
	if intent.Generation != 38 || intent.ExpectedPreviousConfigSHA != lkgSHA || intent.ExpectedPreviousManifestSHA != lkgSHA ||
...
func TestReleaseGuardianIntentBindsCurrentProductionLKG(t *testing.T) {
	...
	const lkgSHA = "82c4d7ddace5de9e3cd53d76414778d497de4370"
	const lkgImage = "sha256:51657de2a3e95abbfb84a92e9004577edcf77edab87aae093bbd5b04f2dbb8db"
	if intent.Generation != 109 || intent.ExpectedPreviousConfigSHA != lkgSHA || intent.ExpectedPreviousManifestSHA != lkgSHA ||
