...
func TestAPIGuardianHandoffBindsProductionLKG(t *testing.T) {
	...
	const failedAtom = "7aa06323217522bf797605212cad67ae8ade06aa"
	if intent.Generation != 35 || intent.ExpectedPreviousConfigSHA != lkgSHA || intent.ExpectedPreviousManifestSHA != lkgSHA ||
