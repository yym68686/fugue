...
func TestAPIGuardianHandoffBindsProductionLKG(t *testing.T) {
	...
	const lkgSHA = "46050072803397becd7b15e1c6f2ee3d21ceac9e"
	const lkgImage = "sha256:f1158da85ef18269362b4fa3aef29bdbe2823d1ebace168239536e89ea9118dc"
	if intent.Generation != 44 || intent.ExpectedPreviousConfigSHA != lkgSHA || intent.ExpectedPreviousManifestSHA != lkgSHA ||
...
func TestReleaseGuardianIntentBindsCurrentProductionLKG(t *testing.T) {
	...
	const lkgSHA = "c72ced1ea1f878a5c9342703b46b8d9996b52cc9"
	const lkgImage = "sha256:daa8c49bd41901d9e875b5374909a3e3c1fdd359fda4c071792efe72a776d989"
	if intent.Generation != 134 || intent.ExpectedPreviousConfigSHA != lkgSHA || intent.ExpectedPreviousManifestSHA != lkgSHA ||
		intent.ExpectedPreviousOCIRevision != lkgSHA || intent.ExpectedPreviousImageDigest != lkgImage || intent.SupersedesFailedConfigSHA != "" {
