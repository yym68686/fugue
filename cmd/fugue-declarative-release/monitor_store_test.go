...
func TestAPIGuardianHandoffBindsProductionLKG(t *testing.T) {
	...
	const failedAtom = "4ead3e90ac79a9eda16210f753975a4dfc3ac17c"
	if intent.Generation != 40 || intent.ExpectedPreviousConfigSHA != lkgSHA || intent.ExpectedPreviousManifestSHA != lkgSHA ||
...
func TestReleaseGuardianIntentBindsCurrentProductionLKG(t *testing.T) {
	...
	const lkgSHA = "e3cc479806701a335cf6009c1b4246d21a8f2a33"
	const lkgImage = "sha256:2802cd36b328d51376303fbf3c8b1a55608b7b85820adcfb83857d3f33a5f3e3"
	if intent.Generation != 117 || intent.ExpectedPreviousConfigSHA != lkgSHA || intent.ExpectedPreviousManifestSHA != lkgSHA ||
