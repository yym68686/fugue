...
func InvariantDefinitions() []model.InvariantDefinition {
	definitions := []model.InvariantDefinition{
		...
		invariant(
			"app.observed_runtime_authority",
			"app",
			model.GatePolicyScopeApp,
			"application-runtime",
			"a deployed application must have fresh cluster, generation, object, namespace, endpoint, image, and replica evidence",
			model.RobustnessSeverityBlockPublish,
			model.GatePolicyModeEnforced,
			"kubernetes_api,managed_app_status",
			"release_guard.block_rollout",
			"",
			"docs/runbooks/observed-runtime-evidence.md",
			"60s",
		...
		invariant(
			"app.route_requires_observed_ready",
			"app",
			model.GatePolicyScopeApp,
			"application-route",
			"a public route cannot be reported ready when the shared observed status is unavailable or the endpoint is not ready",
			model.RobustnessSeverityBlockPublish,
			model.GatePolicyModeEnforced,
			"kubernetes_api,edge_route_bundle",
			"release_guard.block_rollout",
		...
		invariant(
			"app.migration_cutover_verified",
			"app",
			model.GatePolicyScopeApp,
			"application-migration",
			"migration may retire old artifacts only after image, target object, current generation, physical replicas, and endpoint readiness are verified",
			model.RobustnessSeverityBlockPublish,
			model.GatePolicyModeEnforced,
			"migration_ledger,kubernetes_api",
			"release_guard.block_rollout",
			"",
			"docs/runbooks/stateless-runtime-migration.md",
			"90d",
...
func ConsumerContracts() []model.PlatformConsumerContractDefinition {
	return []model.PlatformConsumerContractDefinition{
		{Component: model.PlatformConsumerComponentNodeUpdater, ArtifactKinds: []string{model.PlatformArtifactKindNodeDesiredState, model.PlatformArtifactKindDiscoveryBundle}, Scope: "node", IdentityKind: "node-updater-token", ProtocolVersion: model.PlatformConsumerProtocolVersionV1, SchemaVersion: model.PlatformConsumerSchemaVersionV1, Required: true, LoadLKGFirst: true, AtomicApply: true, LocalProbe: true, HeartbeatGeneration: true, HeartbeatFreshness: "2m", CompatibilityFloor: "v1", ExpectedConsumerSource: "server-side node topology"},
		{Component: model.PlatformConsumerComponentNodeGuardian, ArtifactKinds: []string{model.PlatformArtifactKindNodeGuardianPolicy}, Scope: "node", IdentityKind: "node-updater-token", ProtocolVersion: model.PlatformConsumerProtocolVersionV1, SchemaVersion: model.PlatformConsumerSchemaVersionV1, Required: true, LoadLKGFirst: true, AtomicApply: true, LocalProbe: true, HeartbeatGeneration: true, HeartbeatFreshness: "2m", CompatibilityFloor: "v1", ExpectedConsumerSource: "server-side node topology"},
		{Component: model.PlatformConsumerComponentEdgeWorker, ArtifactKinds: []string{model.PlatformArtifactKindEdgeRouteBundle, model.PlatformArtifactKindEdgeRankingPolicy, model.PlatformArtifactKindTrafficSafetyPolicy}, Scope: "edge-group/hostname", IdentityKind: "edge-token", ProtocolVersion: model.PlatformConsumerProtocolVersionV1, SchemaVersion: model.PlatformConsumerSchemaVersionV1, Required: true, LoadLKGFirst: true, AtomicApply: true, LocalProbe: true, HeartbeatGeneration: true, HeartbeatFreshness: "90s", CompatibilityFloor: "v1", ExpectedConsumerSource: "server-side active edge topology"},
		{Component: model.PlatformConsumerComponentDNSServer, ArtifactKinds: []string{model.PlatformArtifactKindDNSAnswerBundle, model.PlatformArtifactKindEdgeRankingPolicy, model.PlatformArtifactKindTrafficSafetyPolicy}, Scope: "zone/edge-group/hostname", IdentityKind: "dns-token", ProtocolVersion: model.PlatformConsumerProtocolVersionV1, SchemaVersion: model.PlatformConsumerSchemaVersionV1, Required: true, LoadLKGFirst: true, AtomicApply: true, LocalProbe: true, HeartbeatGeneration: true, HeartbeatFreshness: "90s", CompatibilityFloor: "v1", ExpectedConsumerSource: "server-side active DNS topology"},
		{Component: model.PlatformConsumerComponentCaddyEdgeFront, ArtifactKinds: []string{model.PlatformArtifactKindCaddyRouteConfig, model.PlatformArtifactKindEdgeRouteBundle}, Scope: "edge-node", IdentityKind: "edge-token", ProtocolVersion: model.PlatformConsumerProtocolVersionV1, SchemaVersion: model.PlatformConsumerSchemaVersionV1, Required: true, LoadLKGFirst: true, AtomicApply: true, LocalProbe: true, HeartbeatGeneration: true, HeartbeatFreshness: "90s", CompatibilityFloor: "v1", ExpectedConsumerSource: "server-side edge-front topology"},
		{Component: model.PlatformConsumerComponentRuntimeAgent, ArtifactKinds: []string{model.PlatformArtifactKindRuntimePlacementPlan, model.PlatformArtifactKindRuntimeContinuityPlan}, Scope: "runtime/node", IdentityKind: "agent-token", ProtocolVersion: model.PlatformConsumerProtocolVersionV1, SchemaVersion: model.PlatformConsumerSchemaVersionV1, Required: true, LoadLKGFirst: true, AtomicApply: true, LocalProbe: true, HeartbeatGeneration: true, HeartbeatFreshness: "2m", CompatibilityFloor: "v1", ExpectedConsumerSource: "server-side runtime topology"},
		{Component: model.PlatformConsumerComponentImageCache, ArtifactKinds: []string{model.PlatformArtifactKindImageReplicationPlan}, Scope: "node", IdentityKind: "platform-component-identity", ProtocolVersion: model.PlatformConsumerProtocolVersionV1, SchemaVersion: model.PlatformConsumerSchemaVersionV1, Required: true, LoadLKGFirst: true, AtomicApply: true, LocalProbe: true, HeartbeatGeneration: true, HeartbeatFreshness: "2m", CompatibilityFloor: "v1", ExpectedConsumerSource: "server-side node topology"},
	}
}
...
func LKGPolicies() []model.PlatformLKGPolicyDefinition {
	policies := []model.PlatformLKGPolicyDefinition{
		...
		{ArtifactKind: model.PlatformArtifactKindComponentReleasePlan, StorageLocation: "control-plane store:fugue_platform_lkg_snapshots", MaxAge: "24h", MaxStale: "168h", MinimumGenerations: 3, ExpiryBehavior: "observe_only"},
		...
		{ArtifactKind: model.PlatformArtifactKindImageReplicationPlan, StorageLocation: "filesystem:/var/lib/fugue/image-cache/replication-plan.json", CachePathEnv: "FUGUE_IMAGE_CACHE_REPLICATION_PLAN_PATH", MaxAge: "6h", MaxStale: "24h", MinimumGenerations: 3, ArchiveLimit: 5, ExpiryBehavior: "serve_cached_images_hold_new_replication"},
	}
