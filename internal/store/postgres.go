...
var postgresSchemaStatements = []string{
	...
	`CREATE INDEX IF NOT EXISTS idx_fugue_operations_app_desired_source_created ON fugue_operations (app_id, created_at) WHERE desired_source_json IS NOT NULL`,
