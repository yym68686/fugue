...
var postgresSchemaStatements = []string{
	...
	`CREATE TABLE IF NOT EXISTS fugue_edge_dns_bundle_artifacts (
		scope_key TEXT PRIMARY KEY,
		zone TEXT NOT NULL DEFAULT '',
		dns_node_id TEXT NOT NULL DEFAULT '',
		edge_group_id TEXT NOT NULL DEFAULT '',
		answer_ips_json JSONB NOT NULL DEFAULT '[]'::jsonb,
		route_a_answer_ips_json JSONB NOT NULL DEFAULT '[]'::jsonb,
