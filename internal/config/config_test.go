...
func TestObservabilityFromEnvReadsExporterConfiguration(t *testing.T) {
	...
	t.Setenv("FUGUE_OBSERVABILITY_KUBERNETES_LOG_MAX_LINE_BYTES", "2097152")
	...
	if cfg.KubernetesLogLabelSelector != "app.kubernetes.io/managed-by=fugue" || cfg.KubernetesLogPollInterval != 7*time.Second || cfg.KubernetesLogQPS != 12.5 || cfg.KubernetesLogBurst != 25 || cfg.KubernetesLogTailLines != 33 || cfg.KubernetesLogMaxLineBytes != 2097152 || cfg.KubernetesLogMaxPods != 44 || cfg.KubernetesLogMaxLinesPerCycle != 55 {
