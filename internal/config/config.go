...
type DNSConfig struct {
	...
	EdgeHealthProbePathsJSON   string
...
func ObservabilityFromEnv() observability.Config {
	return observability.Config{
		...
		KubernetesLogMaxLineBytes:      getenvInt("FUGUE_OBSERVABILITY_KUBERNETES_LOG_MAX_LINE_BYTES", observability.DefaultKubernetesLogMaxLineBytes),
...
func DNSFromEnv() DNSConfig {
	...
	return DNSConfig{
		...
		EdgeHealthProbePathsJSON:   strings.TrimSpace(os.Getenv("FUGUE_DNS_EDGE_HEALTH_PROBE_PATHS_JSON")),
