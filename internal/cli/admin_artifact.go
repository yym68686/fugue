...
func (c *CLI) newAdminArtifactVerifyLKGCommand() *cobra.Command {
	...
	cmd.Flags().BoolVar(&opts.Evidence.PlatformEvidence, "platform-evidence", false, "Public synthetic probes passed")
	...
	cmd.Flags().StringVar(&stateOpts.PlatformEvidence, "platform-evidence-state", "", "Public synthetic evidence: pass, fail, unknown, or stale")
