...
func TestRunDebugBundleCreatesArchive(t *testing.T) {
	...
	for _, want := range []string{"evidence.json", "backup-status.json", "manifest.json", "logs/runtime-app.log"} {
		if !found[want] {
...
func newDiagnosticEvidenceTestServer(t *testing.T) *httptest.Server {
	...
	return httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case r.Method == http.MethodGet && r.URL.Path == "/v1/apps/app_123/backups/status":
			_, _ = w.Write([]byte(`{"app":{"id":"app_123","tenant_id":"tenant_123","project_id":"project_123","name":"demo","spec":{"runtime_id":"runtime_managed_shared","replicas":1},"status":{"phase":"degraded","current_replicas":1,"last_operation_id":"op_deploy_123"},"created_at":"2026-04-20T00:00:00Z","updated_at":"2026-04-20T00:30:00Z"},"policies":[{"id":"backup_policy_app_123","tenant_id":"tenant_123","project_id":"project_123","app_id":"app_123","name":"app-db-hourly","target":{"type":"app-database","tenant_id":"tenant_123","project_id":"project_123","app_id":"app_123","database":"appdb"},"backend_id":"backup_backend_private","enabled":true,"status":"active","schedule":"0 * * * *","retain_count":3,"created_at":"2026-04-20T00:00:00Z","updated_at":"2026-04-20T00:00:00Z"}],"artifacts":[{"id":"backup_artifact_123","run_id":"backup_run_123","policy_id":"backup_policy_app_123","tenant_id":"tenant_123","project_id":"project_123","app_id":"app_123","target":{"type":"app-database","tenant_id":"tenant_123","project_id":"project_123","app_id":"app_123","database":"appdb"},"backend_id":"backup_backend_private","kind":"app-pg-dump","version":"v1","object_key":"fugue-backups/private/appdb.dump","manifest_object_key":"fugue-backups/private/manifest.json","sha256":"secret-sha256","manifest_digest":"secret-manifest-digest","size_bytes":4096,"logical_bytes":8192,"status":"active","billable":true,"manifest":{"schema_version":"fugue.backup/v1","artifact_id":"backup_artifact_123","run_id":"backup_run_123","policy_id":"backup_policy_app_123","target":{"type":"app-database","app_id":"app_123","database":"appdb"},"kind":"app-pg-dump","version":"v1","object_key":"fugue-backups/private/appdb.dump","manifest_object_key":"fugue-backups/private/manifest.json","sha256":"secret-sha256","size_bytes":4096,"files":[{"path":"database.dump","object_key":"fugue-backups/private/appdb.dump","sha256":"secret-sha256","size":4096}],"created_at":"2026-04-20T00:25:00Z"},"created_at":"2026-04-20T00:25:00Z"}],"posture":[{"target":{"type":"app-database","app_id":"app_123"},"status":"ready","policy_id":"backup_policy_app_123","last_successful_run_id":"backup_run_123","last_successful_at":"2026-04-20T00:25:00Z","billable_bytes":4096}]}`))
