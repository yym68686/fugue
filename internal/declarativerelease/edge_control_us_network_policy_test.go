...
func TestEdgeControlUSNetworkPolicyAddsOnlyExactAPIAuthorityReader(t *testing.T) {
	...
	if intent.Generation != 35 || intent.ExpectedPreviousConfigSHA != lkgSHA ||
	...
	prior := intent
	prior.Generation = 34
	prior.ExpectedPreviousConfigSHA = "54e3a4fa1f9f93aec146d2a45923e014010291e3"
	...
	prior.ExpectedPreviousImageDigest = "sha256:a1d1b2dcd0f6df0318bfea1abd54059eb5181abcae7d71198aa54186fc846e35"
	prior.SupersedesFailedConfigSHA = "ef7b6712b302bf9942a91cc98522ffdc0af68e5f"
	failed := intent
