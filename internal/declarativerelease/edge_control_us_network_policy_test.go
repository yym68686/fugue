...
func TestEdgeControlUSNetworkPolicyAddsOnlyExactAPIAuthorityReader(t *testing.T) {
	...
	if intent.Generation != 16 || intent.ExpectedPreviousConfigSHA != "546958c18232758e30520115e511588081fd72fc" ||
		...
		intent.ExpectedPreviousImageDigest != "sha256:94367a7a8f18b4b2fe0570e7dde15862856a5565b8fe4e28fae3c88e8f512c41" ||
		intent.SupersedesFailedConfigSHA != "cbeb9cf42eb565d5e2ef3f12348739a918e2577c" {
	...
	prior := intent
	prior.Generation = 15
	prior.ExpectedPreviousConfigSHA = "88e95c3b37ee5202662e68d0a492e2959cca780a"
	...
	prior.ExpectedPreviousImageDigest = "sha256:091eca1ac1d94dfbdabc2a52afb0469f7e58427ab355bf3f38a95c3f153b1ecc"
	...
	bound, err := BindIntents(registry, plan, map[string]Intent{us.Control.ID: intent}, map[string]Intent{us.Control.ID: prior},
		map[string]string{us.Control.ID: intent.SupersedesFailedConfigSHA})
