...
const (
	...
	EdgeGroupIDLabelKey         = "fugue.io/edge-group-id"
	EdgeWorkloadLabelKey        = "fugue.io/edge-workload"
	EdgeWorkloadStaticValue     = "static"
	EdgeWorkloadDynamicValue    = "dynamic"
	EdgeLocationStatusLabelKey  = "fugue.io/edge-location-status"
	EdgeLocationStatusReady     = "ready"
	EdgeLocationStatusMissing   = "missing_location"
	PublicIPLabelKey            = "fugue.io/public-ip"
