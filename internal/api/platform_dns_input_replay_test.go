...
func TestPinnedDNSReferencesPersistThroughOperatorReplay(t *testing.T) {
	...
	draft := platformIntentProjectionResponse{Intent: platformconfig.PlatformIntent{Generation: "intent", Scope: "global"}, Policy: platformconfig.NormalizePolicySnapshot(platformconfig.PolicySnapshot{Generation: "traffic", Scope: "global"})}
