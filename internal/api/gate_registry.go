...
func defaultGatePolicies() []model.GatePolicy {
	...
	return []model.GatePolicy{
		...
		{ID: "node.guardian_repair", Description: "node guardian low-risk repair and stateless restart actions", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeNode, IntroducedAt: now, SoakMinDuration: "24h", MinimumSamples: 3, MinimumFailureDomains: 1, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_NODE_GUARDIAN_REPAIR_MODE", RunbookRef: "docs/runbooks/automatic-repair-safety.md"},
		{ID: "node.managed_iptables_repair", Description: "provenance-scoped managed iptables repair", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeNode, IntroducedAt: now, SoakMinDuration: "24h", MinimumSamples: 3, MinimumFailureDomains: 1, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_NODE_MANAGED_IPTABLES_REPAIR_MODE", RunbookRef: "docs/runbooks/stale-iptables-managed-rule.md"},
		{ID: "platform.lkg_reload", Description: "consumer reload of a verified local LKG bundle", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeEdgeNode, IntroducedAt: now, SoakMinDuration: "24h", MinimumSamples: 1, MinimumFailureDomains: 1, BlastRadius: model.GateBlastRadiusPolicy{MaxEdgesPerGroup: 1, PreserveMinHealthyEdgeGroups: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_PLATFORM_LKG_RELOAD_MODE", RunbookRef: "docs/runbooks/data-plane-lkg-autonomy.md"},
		{ID: "edge.peer_fallback", Description: "request-level fallback to a verified alternate edge peer", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeHostname, IntroducedAt: now, SoakMinDuration: "24h", MinimumSamples: 3, MinimumFailureDomains: 2, BlastRadius: model.GateBlastRadiusPolicy{PreserveMinEligibleEdgesPerHost: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_EDGE_PEER_FALLBACK_MODE", RunbookRef: "docs/runbooks/data-plane-lkg-autonomy.md"},
		{ID: "release.automatic_rollback", Description: "automatic rollback after a hard public release regression", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeCluster, IntroducedAt: now, SoakMinDuration: "24h", MinimumSamples: 1, MinimumFailureDomains: 1, BlastRadius: model.GateBlastRadiusPolicy{PreserveMinHealthyEdgeGroups: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_RELEASE_AUTOMATIC_ROLLBACK_MODE", RunbookRef: "docs/runbooks/bad-control-plane-release-rollback.md"},
