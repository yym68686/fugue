...
func defaultGatePolicies() []model.GatePolicy {
	...
	rollbackSignals := []string{"platform_evidence_503_no_healthy_edge_groups", "release_guard_block_rollout"}
	return []model.GatePolicy{
		{ID: "automation.app-restart", Description: "bounded application restart proposals after sustained request unavailability", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeApp, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 1, BlastRadius: model.GateBlastRadiusPolicy{MaxApps: 1}, RollbackOn: []string{"app_restart_readiness_regression", "app_restart_loop_detected"}, KillSwitchEnv: "FUGUE_GATE_AUTOMATION_APP_RESTART_MODE", RunbookRef: "docs/runbooks/app-automation-restart.md"},
		{ID: "node.kubernetes_service_dns", Description: "pod-network Kubernetes Service DNS deep health", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeNode, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 2, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_NODE_KUBERNETES_SERVICE_DNS_MODE", RunbookRef: "docs/runbooks/node-dns-failure.md"},
		{ID: "node.kube_proxy_rules", Description: "kube-proxy and managed iptables deep health", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeNode, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 2, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_NODE_KUBE_PROXY_RULES_MODE", RunbookRef: "docs/runbooks/stale-iptables-managed-rule.md"},
		{ID: "node.cni_bridge", Description: "node CNI bridge health", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeNode, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 2, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_NODE_CNI_BRIDGE_MODE", RunbookRef: "docs/runbooks/node-dns-failure.md"},
		{ID: "node.conntrack_saturation", Description: "node conntrack saturation health", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeNode, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 2, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_NODE_CONNTRACK_SATURATION_MODE", RunbookRef: "docs/runbooks/node-dns-failure.md"},
		{ID: "edge.route_inventory_quarantine", Description: "edge route inventory quarantine filtering", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeEdgeGroup, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 2, BlastRadius: model.GateBlastRadiusPolicy{MaxEdgesPerGroup: 1, PreserveMinHealthyEdgeGroups: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_EDGE_ROUTE_INVENTORY_QUARANTINE_MODE", RunbookRef: "docs/runbooks/edge-route-all-unhealthy.md"},
		{ID: "dns.answer_route_ready", Description: "DNS answer route-ready filtering", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeHostname, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 2, BlastRadius: model.GateBlastRadiusPolicy{PreserveMinEligibleEdgesPerHost: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_DNS_ANSWER_ROUTE_READY_MODE", RunbookRef: "docs/runbooks/edge-route-all-unhealthy.md"},
		{ID: "scheduler.node_quarantine", Description: "scheduler exclusion of quarantined runtime nodes", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeRuntime, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 2, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_SCHEDULER_NODE_QUARANTINE_MODE", RunbookRef: "docs/runbooks/release-guard-blocked.md"},
		{ID: "node.guardian_repair", Description: "node guardian low-risk repair and stateless restart actions", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeNode, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 1, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_NODE_GUARDIAN_REPAIR_MODE", RunbookRef: "docs/runbooks/automatic-repair-safety.md"},
		{ID: "node.managed_iptables_repair", Description: "provenance-scoped managed iptables repair", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeNode, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 1, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_NODE_MANAGED_IPTABLES_REPAIR_MODE", RunbookRef: "docs/runbooks/stale-iptables-managed-rule.md"},
		{ID: "platform.lkg_reload", Description: "consumer reload of a verified local LKG bundle", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeEdgeNode, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 1, MinimumFailureDomains: 1, BlastRadius: model.GateBlastRadiusPolicy{MaxEdgesPerGroup: 1, PreserveMinHealthyEdgeGroups: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_PLATFORM_LKG_RELOAD_MODE", RunbookRef: "docs/runbooks/data-plane-lkg-autonomy.md"},
		{ID: "edge.peer_fallback", Description: "request-level fallback to a verified alternate edge peer", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeHostname, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 3, MinimumFailureDomains: 2, BlastRadius: model.GateBlastRadiusPolicy{PreserveMinEligibleEdgesPerHost: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_EDGE_PEER_FALLBACK_MODE", RunbookRef: "docs/runbooks/data-plane-lkg-autonomy.md"},
		{ID: "release.automatic_rollback", Description: "automatic rollback after a hard public release regression", Mode: model.GatePolicyModeShadow, DefaultMode: model.GatePolicyModeShadow, Scope: model.GatePolicyScopeCluster, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 1, MinimumFailureDomains: 1, BlastRadius: model.GateBlastRadiusPolicy{PreserveMinHealthyEdgeGroups: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_RELEASE_AUTOMATIC_ROLLBACK_MODE", RunbookRef: "docs/runbooks/bad-control-plane-release-rollback.md"},
		{ID: "public.synthetic_503", Description: "public synthetic probes detecting Fugue 503 classes", Mode: model.GatePolicyModeEnforced, DefaultMode: model.GatePolicyModeEnforced, Scope: model.GatePolicyScopeCluster, IntroducedAt: now, SoakMinDuration: "0s", MinimumSamples: 1, BlastRadius: model.GateBlastRadiusPolicy{PreserveMinHealthyEdgeGroups: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_PLATFORM_EVIDENCE_503_MODE", RunbookRef: "docs/runbooks/bad-control-plane-release-rollback.md"},
		...
		{ID: "node_updater.generation_rollout", Description: "node-updater desired generation rollout", Mode: model.GatePolicyModeCanary, DefaultMode: model.GatePolicyModeCanary, Scope: model.GatePolicyScopeNode, IntroducedAt: now, SoakMinDuration: "10m", MinimumSamples: 1, MinimumFailureDomains: 1, CanaryFailureDomains: []string{"single-node"}, BlastRadius: model.GateBlastRadiusPolicy{MaxNodes: 1}, RollbackOn: rollbackSignals, KillSwitchEnv: "FUGUE_GATE_NODE_UPDATER_GENERATION_ROLLOUT_MODE", RunbookRef: "docs/runbooks/node-updater-canary-restore.md"},
	}
}
...
func mergeGatePolicy(base, override model.GatePolicy) model.GatePolicy {
	...
	if strings.TrimSpace(override.SoakMinDuration) != "" {
		base.SoakMinDuration = boundedGatePolicyDuration(longerGatePolicyDuration(base.SoakMinDuration, override.SoakMinDuration))
	}
	base.SoakMinDuration = boundedGatePolicyDuration(base.SoakMinDuration)
...
func restrictNewGatePolicy(policy model.GatePolicy) model.GatePolicy {
	...
	policy.SoakMinDuration = boundedGatePolicyDuration(policy.SoakMinDuration)
...
const (
	maxProductionGateObservation     = 10 * time.Minute
	maxProductionGateObservationText = "10m"
)

func boundedGatePolicyDuration(raw string) string {
