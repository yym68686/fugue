...
func TestBackupInputBundleWorkflowIsReadOnly(t *testing.T) {
	...
	for _, required := range []string{
		...
		"internal/api/backup_materializer.go",
		"internal/api/routes_gen.go",
		"internal/apispec/backup_materializer_test.go",
		...
		"go test -race ./internal/api -run TestBackupMaterializerEndpoint",
		"Test(BackupMaterializerOpenAPIContractIsPrivateStrictAndDefaultOff|GeneratedArtifactsAreUpToDate|EmbeddedSpecIsValid)",
		"go vet ./internal/api ./internal/apispec ./internal/backupmaterializer/",
