...
func TestControlPlaneDeployRequiresInternalReleaseGate(t *testing.T) {
	...
	assertWorkflowSourceDigest(t, data, "e4b4c97c5e546d75d904969809b9547a5049593dc8083f54937425cfa8d40580")
	var workflow releaseWorkflow
	if err := yaml.Unmarshal(data, &workflow); err != nil {
		t.Fatalf("parse control-plane workflow: %v", err)
	}
	...
	assertWorkflowRunDigests(t, workflow.Jobs, map[string]string{
		...
		"recover-controller-m16-observed-state/Verify exact Controller M16 observed recovery identity":       "0c6a9e60d581875c5996dfbbbffb0f8d5936b00819a03363187fb44879448f10",
	...
	for _, required := range []string{"168699dff1ef57958b01973d46db3cc92babec30", "d412416cbca7094ee19d996f312468f871988fdb", "fbfa707084d429176783354745043b5c12b3b488", "internal/releasedomain/control_plane_hotfix_adoption.go", "scripts/test_control_plane_hotfix_adoption.sh", "deploy/helm/fugue go.mod go.sum scripts/lib"} {
