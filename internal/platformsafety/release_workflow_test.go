...
func TestControlPlaneDeployRequiresInternalReleaseGate(t *testing.T) {
	...
	t.Run("Telemetry declarative CI is singleton and shares the global mutation mutex", func(t *testing.T) {
		...
		expectedIntent := map[string]any{
			...
			"desiredSourceSha":            "b02b539c4393cca04f96d3e1a3fd5a1cc7ae0b84",
			"environment":                 "production",
			"expectedPreviousImageDigest": "sha256:b191fa38e9b098ce5bfa0747c089999cc6812b3dc6c65bcdf2cf94e467a0f1a0",
			"expectedPreviousSourceSha":   "10b7061f91d653d13a3c3f95abfd4b996f17ddab",
			"fieldManager":                "fugue-telemetry-declarative",
			"intentGeneration":            float64(5),
