...
func TestControlPlaneDeployRequiresInternalReleaseGate(t *testing.T) {
	...
	t.Run("Telemetry declarative CI is singleton and shares the global mutation mutex", func(t *testing.T) {
		...
		expectedIntent := map[string]any{
			...
			"desiredSourceSha":            "5a3b09c571601993367c50561b257dd6b9e743ca",
			"environment":                 "production",
			"expectedPreviousImageDigest": "sha256:7e4a377725961b359d81bf48df3c02f1cd8580108abd3e737c4f0d7c83d4107f",
			"expectedPreviousSourceSha":   "b02b539c4393cca04f96d3e1a3fd5a1cc7ae0b84",
			"fieldManager":                "fugue-telemetry-declarative",
			"intentGeneration":            float64(6),
	...
	t.Run("Telemetry component planner rejects a non-singleton release", func(t *testing.T) {
		...
		successorIntent := map[string]any{
			...
			"expectedPreviousSourceSha":   "5a3b09c571601993367c50561b257dd6b9e743ca",
			"fieldManager":                "fugue-telemetry-declarative",
			"intentGeneration":            7,
			"kind":                        "ProductionComponentRelease",
			"namespace":                   "fugue-system",
