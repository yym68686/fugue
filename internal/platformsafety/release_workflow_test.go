...
func TestControlPlaneDeployRequiresInternalReleaseGate(t *testing.T) {
	...
	assertWorkflowSourceDigest(t, data, "89700f9025dc5ece826ae964a84fa8f7faba6796188cf66dd2950a58c58cbbf7")
	var workflow releaseWorkflow
	if err := yaml.Unmarshal(data, &workflow); err != nil {
		t.Fatalf("parse control-plane workflow: %v", err)
	}
	...
	assertWorkflowRunDigests(t, workflow.Jobs, map[string]string{
		...
		"recover-controller-m16-observed-state/Verify exact Controller M16 observed recovery identity":       "76a9fb00fedf2f1bbcab7e6735cfae19b477a6bf21be7e6f81d403a1fc143163",
