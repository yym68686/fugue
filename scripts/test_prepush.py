...
class CanonicalReceiptTest(unittest.TestCase):
    def test_ci_always_runs_the_single_repository_prepush_entrypoint(self) -> None:
        ...
        self.assertEqual(source.count('PREPUSH_TIMEOUT_SECONDS: "240"'), 1)
        self.assertEqual(source.count('PREPUSH_MAX_ELAPSED_SECONDS: "240"'), 1)
        self.assertEqual(prepush.MAX_CONFIGURED_TIMEOUT_SECONDS, 240.0)
        self.assertEqual(prepush.MAX_CONFIGURED_ELAPSED_SECONDS, 240.0)
