...
image_cache_strategy_target_fingerprints_match() {
  ...
  CHART_ROOT="${REPO_ROOT}/deploy/helm/fugue" \
    ...
    EXPECTED_VALUES_SHA256_CONTROLLER_768="5023828a5d607119a3fc8a464a665dcad20b11561c7197e3a0a786dce87ad340" \
...
expected_by_values = {
    ...
    os.environ["EXPECTED_VALUES_SHA256_CONTROLLER_768"]: {
