...
main() {
  ...
  FUGUE_IMAGE_STORE_TARGET_REPLICAS="${FUGUE_IMAGE_STORE_TARGET_REPLICAS:-2}"
  ...
  FUGUE_IMAGE_STORE_ORPHAN_PRUNE_MODE="${FUGUE_IMAGE_STORE_ORPHAN_PRUNE_MODE:-observe}"
  ...
  FUGUE_IMAGE_STORE_ORPHAN_PRUNE_MAX_DELETE_BYTES_PER_NODE="${FUGUE_IMAGE_STORE_ORPHAN_PRUNE_MAX_DELETE_BYTES_PER_NODE:-1073741824}"
