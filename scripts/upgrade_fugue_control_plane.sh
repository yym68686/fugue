...
main() {
  ...
  FUGUE_OBSERVABILITY_KUBERNETES_LOG_TAIL_LINES="${FUGUE_OBSERVABILITY_KUBERNETES_LOG_TAIL_LINES:-200}"
  FUGUE_OBSERVABILITY_KUBERNETES_LOG_MAX_PODS="${FUGUE_OBSERVABILITY_KUBERNETES_LOG_MAX_PODS:-500}"
  FUGUE_OBSERVABILITY_KUBERNETES_LOG_MAX_LINES_PER_CYCLE="${FUGUE_OBSERVABILITY_KUBERNETES_LOG_MAX_LINES_PER_CYCLE:-5000}"
