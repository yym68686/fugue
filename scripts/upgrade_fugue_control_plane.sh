...
image_cache_strategy_target_fingerprints_match() {
  ...
  CHART_ROOT="${REPO_ROOT}/deploy/helm/fugue" \
    EXPECTED_SHA256_CURRENT="21d2c9414ec0d74495de7836d4035ede2151cdd7f61f4febe121ab85e5bfa339" \
    EXPECTED_SHA256_SOURCE_COMMIT="69b3d87dfb69a28ccc8cbd11be9470420ec27b7b38ed7d2ba623ac9565787570" \
    EXPECTED_SHA256_SOURCE_COMMIT_GUARDED="7e279fdd4284b8caf08022bfa7e30a3c5136f4a43be8494e8f3836821d279d10" \
    python3 -c '
import hashlib
import os
