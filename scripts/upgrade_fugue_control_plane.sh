...
image_cache_strategy_target_fingerprints_match() {
  ...
  CHART_ROOT="${REPO_ROOT}/deploy/helm/fugue" \
    EXPECTED_SHA256_CURRENT="dc3fecc0e683df8853cc7de0b8960eef6c7cc76ae46b10467d6ba1c838fe88e8" \
    EXPECTED_SHA256_SOURCE_COMMIT="a60a5afe077b6b614d8ff65e4e2a817ec31cdff4f1180b5481a16e06f933099e" \
    EXPECTED_SHA256_SOURCE_COMMIT_GUARDED="de5252ffba5e07fc509d7b7b04348924c6c7ba4b36e00dee23215232c3b142cd" \
    python3 -c '
import hashlib
import os
