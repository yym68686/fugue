...
.PHONY: test generate-openapi generate-openapi-check build build-api build-controller build-agent build-edge build-dns build-cli run-api run-controller run-agent
